...
void BaseApplication::chooseSceneManager(void)
{
    ...
    mSceneMgr2 = mRoot->createSceneManager(Ogre::ST_GENERIC);
}
//-------------------------------------------------------------------------------------
void BaseApplication::createCamera(void)
{
    ...
    mCamera2->setPosition(Ogre::Vector3(0,350,0.0001)); 
...
void BaseApplication::createViewports(void)
{
    ...
    */
    ...
    // viewport2
    Ogre::Viewport* vp2 = mWindow->addViewport(mCamera2, 1, 0, 0, 0.25, 0.25);
